...
| `lastUpdate` | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) object | The date the manga was last updated. |
...
| `Unknown` | 2 | An unknown manga status. |
| `Abandoned` | 3 | A manga that is abandoned. |
| `Hiatus` | 4 | A manga that is on hiatus. |
...
| `badge` | number | The badge value which should be shown on this tile |
